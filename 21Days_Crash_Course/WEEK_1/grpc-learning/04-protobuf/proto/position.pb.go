...
type Position struct {
	...
	RiskScore     float64                `protobuf:"fixed64,2,opt,name=RiskScore,proto3" json:"RiskScore,omitempty"`
...
func (x *Position) GetRiskScore() float64 {
	if x != nil {
		return x.RiskScore
	}
	return 0
...
const file_position_proto_rawDesc = "" +
	"\n" +
	"\x0eposition.proto\x12\bposition\"^\n" +
	"\bposition\x12\x16\n" +
	"\x06symbol\x18\x01 \x01(\tR\x06symbol\x12\x1c\n" +
	"\tRiskScore\x18\x02 \x01(\x01R\tRiskScore\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\tR\ttimestampB@Z>github.com/mr-siddd/grpc-learning/04-protobuf/proto;positionpbb\x06proto3"
